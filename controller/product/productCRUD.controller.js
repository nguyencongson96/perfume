...
const productCRUD = {
  ...
  addProduct: async (req, res) => {
    try {
      ...
      return res
        ...
        .json(err.msg || "Error occurred while adding");
    }
  },
  updateProduct: async (req, res) => {
    try {
      ...
      return res
        .status(err.status || 500)
        .json(err.msg || "Error occurred while updating");
    }
  },
  deleteProduct: async (req, res) => {
    try {
      ...
      return res
        .status(err.status || 500)
        .json(err.msg || "Error occurred while deleting");
    }
  },
  getAProduct: async (req, res) => {
    try {
      ...
      return res
        .status(err.status || 500)
        .json(err.msg || "Error occurred while getting");
    }
  },
  test: async (req, res) => {
    try {
